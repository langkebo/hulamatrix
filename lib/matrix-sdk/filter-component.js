...
export class FilterComponent {
  ...
  check(event) {
    ...
    var relationSenders = [];
    var threadRelation = bundledRelationships === null || bundledRelationships === void 0 ? void 0 : bundledRelationships[THREAD_RELATION_TYPE.name];
    if (this.userId && threadRelation !== null && threadRelation !== void 0 && threadRelation.current_user_participated) {
