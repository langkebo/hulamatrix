 ...
 */
interface IUserDirectoryListResponse {
    /**
     * List of users in the directory.
     */
    users: {
        user_id: string;
        display_name?: string;
    ...
    total?: number;
    /**
     * Whether the results are limited.
     */
    limited?: boolean;
}
...
export declare class MatrixClient extends TypedEventEmitter<EmittedEvents, ClientEventHandlerMap> {
     ...
     * @returns Promise which resolves: On success, the empty object `{}`
     */
    logoutAll(stopClient?: boolean): Promise<EmptyObject>;
    /**
     ...
     */
    getUserDirectoryList({ limit, since, }?: {
        limit?: number;
        since?: string;
    }): Promise<IUserDirectoryListResponse>;
    /**
