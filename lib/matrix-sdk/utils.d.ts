 ...
 */
export declare function encodeUri(pathTemplate: string, variables: Record<string, string | null | undefined>): string;
/**
 ...
 */
export declare function deepCompare(x: unknown, y: unknown): boolean;
/**
 ...
 */
export declare function deepSortedObjectEntries(obj: unknown): [string, unknown][];
/**
 ...
 */
export declare function simpleRetryOperation<T>(promiseFn: (attempt: number) => Promise<T>, shouldRetry?: (e: unknown) => boolean): Promise<T>;
/**
 ...
 */
export declare function recursiveMapToObject(map: Map<unknown, unknown>): Record<string, unknown>;
