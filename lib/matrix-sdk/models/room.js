...
export class Room extends ReadReceipt {
  ...
  getFunctionalMembers() {
    ...
    var content = mFunctionalMembers === null || mFunctionalMembers === void 0 ? void 0 : mFunctionalMembers.getContent();
    var serviceMembers = content === null || content === void 0 ? void 0 : content.service_members;
  ...
  loadMembersIfNeeded() {
    ...
    inMemoryUpdate.then(fromServer => {
      if (fromServer) {
        ...
        return store.setOutOfBandMembers(this.roomId, oobMembers).catch(err => {
  ...
  clearNotificationsOnReceipt(event) {
    ...
    for (var [, receiptGroup] of Object.entries(content)) {
      if (typeof receiptGroup !== "object" || receiptGroup === null) continue;
  ...
  /**
   * Get multiple members by their user IDs efficiently.
   * This is optimized for batch lookups.
  ...
  getMembersByUserIds(userIds) {
    return this.currentState.getMembersByUserIds(userIds);
  }
