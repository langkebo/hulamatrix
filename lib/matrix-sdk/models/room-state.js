...
export class RoomState extends TypedEventEmitter {
  ...
  getRoomVersion() {
    ...
    return (_ref = createEvent.getContent()["room_version"]) !== null && _ref !== void 0 ? _ref : "1";
  }
  ...
  /**
   * Get multiple room members by their user IDs efficiently.
   * This is optimized for batch lookups to avoid O(n) lookups.
   * @param userIds - Array of user IDs to look up.
   * @returns Map of user ID to member (only includes members that exist).
   */
  getMembersByUserIds(userIds) {
    var result = new Map();
  ...
  mayTriggerNotifOfType(notifLevelKey, userId) {
    ...
    var powerLevelsEvent = this.getStateEvents(EventType.RoomPowerLevels, "");
    var notifLevel = 50;
    var plContent = powerLevelsEvent === null || powerLevelsEvent === void 0 ? void 0 : powerLevelsEvent.getContent();
    var notifications = plContent === null || plContent === void 0 ? void 0 : plContent.notifications;
    if (notifications && isNumber(notifications[notifLevelKey])) {
      notifLevel = notifications[notifLevelKey];
    }
  ...
  getHistoryVisibility() {
    ...
    var historyVisibilityContent = historyVisibilityEvent === null || historyVisibilityEvent === void 0 ? void 0 : historyVisibilityEvent.getContent();
    return (historyVisibilityContent === null || historyVisibilityContent === void 0 ? void 0 : historyVisibilityContent.history_visibility) || HistoryVisibility.Shared;
  }
  ...
  getGuestAccess() {
    ...
    var guestAccessContent = guestAccessEvent === null || guestAccessEvent === void 0 ? void 0 : guestAccessEvent.getContent();
    return (guestAccessContent === null || guestAccessContent === void 0 ? void 0 : guestAccessContent.guest_access) || GuestAccess.Forbidden;
  }
  ...
  updateThirdPartyTokenCache(memberEvent) {
    ...
    var thirdPartyInvite = content.third_party_invite;
    if (!thirdPartyInvite) {
      return;
    }
    var token = (thirdPartyInvite.signed || {}).token;
    if (!token) {
      return;
    }
