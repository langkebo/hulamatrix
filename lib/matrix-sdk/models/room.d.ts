...
import { MatrixEvent, MatrixEventEvent, type MatrixEventHandlerMap } from "./event.ts";
...
export declare class Room extends ReadReceipt<RoomEmittedEvents, RoomEventHandlerMap> {
     ...
     * @internal
     */
    _unstable_addStickyEvents(events: MatrixEvent[]): ReturnType<RoomStickyEventsStore["addStickyEvents"]>;
    /**
