 ...
 */
export declare class TypedEventEmitter<Events extends string, Arguments extends ListenerMap<Events>, SuperclassArguments extends ListenerMap<string> = Arguments> extends EventEmitter {
    /**
     * Alias for {@link on}.
     */
