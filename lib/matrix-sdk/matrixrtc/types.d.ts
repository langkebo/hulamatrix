...
export interface EncryptionKeysEventContent extends Record<string, unknown> {
 ...
 */
export interface EncryptionKeysToDeviceEventContent extends Record<string, unknown> {
    keys: {
        index: number;
        key: string;
    };
 ...
 */
export interface ICallNotifyContent extends Record<string, unknown> {
    "application": string;
 ...
 */
export interface IRTCNotificationContent extends RelationEvent, Record<string, unknown> {
    "m.mentions"?: IMentions;
 ...
 */
export interface IRTCDeclineContent extends RelationEvent, Record<string, unknown> {
}
