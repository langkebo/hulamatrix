...
/**
 * Regex to match MSC version for membership key format.
 * MSC3757 and MSC3779 use a different membership key format.
 */
var MSC_VERSION_REGEX = /^org\.matrix\.msc(3757|3779)\b/;
...
export class MembershipManager extends TypedEventEmitter {
  ...
  leave(timeout) {
    ...
    if (!this.leavePromiseResolvers) {
      ...
      // Clear any existing leave timeout to prevent memory leaks
      if (this.leaveTimeoutId !== undefined) {
      ...
      if (timeout) {
        this.leaveTimeoutId = setTimeout(() => {
          ...
          (_this$leavePromiseRes2 = this.leavePromiseResolvers) === null || _this$leavePromiseRes2 === void 0 || _this$leavePromiseRes2.resolve(false);
        }, timeout);
      }
    }
  ...
  constructor(joinConfig, room, client, slotDescription, parentLogger) {
    ...
    _defineProperty(this, "restartTimeoutId", void 0);
    _defineProperty(this, "leaveTimeoutId", void 0);
  ...
  restartDelayedEvent(delayId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (_this5.restartTimeoutId !== undefined) {
        clearTimeout(_this5.restartTimeoutId);
        _this5.restartTimeoutId = undefined;
      }
      ...
      var abortPromise = new Promise((_, reject) => {
        ...
        _this5.restartTimeoutId = setTimeout(() => {
          _this5.restartTimeoutId = undefined;
      ...
      return yield Promise.race([_this5.client._unstable_restartScheduledDelayedEvent(delayId), abortPromise]).then(() => {
        ...
        // Clear the timeout if the promise race completes (either winner)
        if (_this5.restartTimeoutId !== undefined) {
          clearTimeout(_this5.restartTimeoutId);
          _this5.restartTimeoutId = undefined;
        }
  ...
  makeMembershipStateKey(localUserId, localDeviceId) {
    ...
    if (MSC_VERSION_REGEX.exec(this.room.getVersion())) {
      return stateKey;
    } else {
