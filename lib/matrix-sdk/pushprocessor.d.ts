...
export interface IActionsObject {
    ...
    tweaks: Partial<Record<TweakName, string | boolean | number>>;
}
export declare class PushProcessor {
     ...
     */
    static rewriteDefaultRules(logger: Logger, incomingRules: IPushRules, _userId?: string | undefined): IPushRules;
    /**
