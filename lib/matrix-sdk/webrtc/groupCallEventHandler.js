...
export class GroupCallEventHandler {
  ...
  createGroupCallFromRoomStateEvent(event) {
    ...
    var dataChannelsEnabled = content.dataChannelsEnabled;
    var rawChannelOptions = content.dataChannelOptions;
    if (dataChannelsEnabled && rawChannelOptions) {
    ...
    dataChannelsEnabled || this.client.isVoipWithNoMediaAllowed, dataChannelOptions, this.client.isVoipWithNoMediaAllowed, this.client.useLivekitForGroupCalls, content["io.element.livekit_service_url"]);
