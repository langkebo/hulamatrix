...
export class TrackStatsBuilder {
  ...
  static buildBitrateReceived(trackStats, now, before) {
    var _now$bytesReceived, _before$bytesReceived;
    trackStats.setBitrate({
      download: TrackStatsBuilder.calculateBitrate((_now$bytesReceived = now.bytesReceived) !== null && _now$bytesReceived !== void 0 ? _now$bytesReceived : 0, (_before$bytesReceived = before.bytesReceived) !== null && _before$bytesReceived !== void 0 ? _before$bytesReceived : 0, now.timestamp, before.timestamp),
      upload: 0
    });
  }
  static buildBitrateSend(trackStats, now, before) {
    var _now$bytesSent, _before$bytesSent;
    trackStats.setBitrate({
      download: 0,
      upload: this.calculateBitrate((_now$bytesSent = now.bytesSent) !== null && _now$bytesSent !== void 0 ? _now$bytesSent : 0, (_before$bytesSent = before.bytesSent) !== null && _before$bytesSent !== void 0 ? _before$bytesSent : 0, now.timestamp, before.timestamp)
    });
  }
  ...
  static calculateBitrate(bytesNow, bytesBefore, nowTimestamp, beforeTimestamp) {
