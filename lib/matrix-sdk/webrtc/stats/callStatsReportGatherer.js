      ...
      if (_this.isActive) {
        ...
        if (typeof (statsPromise === null || statsPromise === void 0 ? void 0 : statsPromise.then) === "function") {
          return statsPromise.then(report => {
            ...
            // Handle both legacy getStats API (with .result()) and modern API
            // Legacy: https://developer.mozilla.org/en-US/docs/Web/API/RTCStatsProvider#result
            // Modern: RTCStatsReport is directly iterable
            _this.currentStatsReport = typeof report === "object" && "result" in report && typeof report.result === "function" ? report.result() : report;
            try {
