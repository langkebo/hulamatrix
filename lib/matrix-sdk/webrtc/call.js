      ...
      if (event.getLocalAge()) {
        ...
        var ringingTimer = setTimeout(() => {
          if (_this8.state == CallState.Ringing) {
            ...
            _this8.stopAllMedia();
            if (_this8.peerConn && _this8.peerConn.signalingState != "closed") {
              // Remove event listeners before closing to prevent potential memory leaks
              if (typeof _this8.peerConn.removeEventListener === "function") {
                _this8.peerConn.removeEventListener("iceconnectionstatechange", _this8.onIceConnectionStateChanged);
                _this8.peerConn.removeEventListener("signalingstatechange", _this8.onSignallingStateChanged);
                _this8.peerConn.removeEventListener("icecandidate", _this8.gotLocalIceCandidate);
                _this8.peerConn.removeEventListener("icegatheringstatechange", _this8.onIceGatheringStateChange);
                _this8.peerConn.removeEventListener("track", _this8.onTrack);
                _this8.peerConn.removeEventListener("negotiationneeded", _this8.onNegotiationNeeded);
                _this8.peerConn.removeEventListener("datachannel", _this8.onDataChannel);
              }
  ...
  terminate(hangupParty, hangupReason, shouldEmit) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (_this29.peerConn && _this29.peerConn.signalingState !== "closed") {
        // Remove event listeners before closing to prevent potential memory leaks
        if (typeof _this29.peerConn.removeEventListener === "function") {
          _this29.peerConn.removeEventListener("iceconnectionstatechange", _this29.onIceConnectionStateChanged);
          _this29.peerConn.removeEventListener("signalingstatechange", _this29.onSignallingStateChanged);
          _this29.peerConn.removeEventListener("icecandidate", _this29.gotLocalIceCandidate);
          _this29.peerConn.removeEventListener("icegatheringstatechange", _this29.onIceGatheringStateChange);
          _this29.peerConn.removeEventListener("track", _this29.onTrack);
          _this29.peerConn.removeEventListener("negotiationneeded", _this29.onNegotiationNeeded);
          _this29.peerConn.removeEventListener("datachannel", _this29.onDataChannel);
        }
