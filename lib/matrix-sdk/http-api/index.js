...
/**
 * Default timeout for upload operations in milliseconds (30 seconds).
 */
...
export class MatrixHttpApi extends FetchHttpApi {
  ...
  uploadContent(file) {
    ...
    if (globalThis.XMLHttpRequest) {
      ...
      var timeoutTimer = callbacks.setTimeout(timeoutFn, DEFAULT_UPLOAD_TIMEOUT_MS);
      ...
      xhr.upload.onprogress = ev => {
        ...
        timeoutTimer = callbacks.setTimeout(timeoutFn, DEFAULT_UPLOAD_TIMEOUT_MS);
