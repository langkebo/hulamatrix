...
/**
 * Maximum time to wait for the device to become visible via the homeserver (in milliseconds).
 */
var DEVICE_VISIBILITY_TIMEOUT_MS = 10000; // 10 seconds
  ...
  shareSecrets() {
    ...
    return _asyncToGenerator(function* () {
      if (_this4.isNewDevice) {
        ...
        var timeout = Date.now() + DEVICE_VISIBILITY_TIMEOUT_MS;
        do {
