...
export declare const STORAGE_SECURITY_AUDIT: {
    readonly logKeyOperation: (operation: string, keyId: string, details?: Record<string, unknown>) => void;
    readonly logSecretOperation: (operation: string, secretName: string, details?: Record<string, unknown>) => void;
    readonly warnSensitiveDataAccess: (operation: string) => void;
};
/**
