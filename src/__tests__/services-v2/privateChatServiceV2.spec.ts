...
describe('PrivateChatServiceV2', () => {
    ...
    describe('List Sessions', () => {
        ...
        it('should use cache when useCache is true', async () => {
            ...
            expect(mockMatrixClient.privateChatV2.listSessions).toHaveBeenCalledTimes(1)
        })
    ...
    describe('Create Session', () => {
        ...
        it('should handle create errors', async () => {
            ...
            await privateChatServiceV2.initialize()
            await expect(
                privateChatServiceV2.createSession({ participants: ['@bob:matrix.org'] })
    ...
    describe('Subscribe to Messages', () => {
        it('should subscribe to messages successfully', async () => {
            ...
            expect(mockMatrixClient.privateChatV2.subscribeToMessages).toHaveBeenCalledWith('session-1', handler)
        })
    ...
    describe('Event Handling', () => {
        it('should emit session.created event', async () => {
            ...
            onCallback?.(mockSessions[0])

            expect(handler).toHaveBeenCalledWith(mockSessions[0])
        })
        ...
        it('should emit message.received event', async () => {
            ...
            onCallback?.(mockMessages[0])

            expect(handler).toHaveBeenCalledWith(mockMessages[0])
        })
