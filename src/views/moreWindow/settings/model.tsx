  ...
  return computed<Topic>(() => [
    {
      ...
      model: (() => (
        <div class="size-full flex">
          <div class="bg-var(--hula-brand-primary) flex-1 rounded-[6px_0_0_6px]"></div>

          <div class="bg-#fff flex-[3.5] p-[8px_4px] box-border flex flex-col gap-8px">
            <div class="flex gap-4px">
              <div class="bg-var(--hula-brand-primary) size-10px rounded-50%"></div>
              <div class="flex flex-col gap-2px">
                <div class="bg-var(--hula-brand-primary) w-16px h-4px"></div>
                <div class="bg-var(--hula-brand-primary) w-24px h-4px"></div>
              </div>
            </div>
          ...
          <div class="bg-var(--hula-brand-primary) flex-[5.5] p-[8px_4px] rounded-[0_6px_6px_0] flex flex-col gap-8px">
            ...
            <div class="flex-y-center gap-4px ml-a">
              <div class="bg-var(--hula-brand-primary) w-28px h-6px"></div>
              <div class="bg-#ccc w-6px h-6px rounded-50%"></div>
            </div>
          </div>
        </div>
    ...
    },
    {
      ...
      model: (() => (
        <div class="size-full flex">
          ...
          <div class="bg-var(--hula-brand-primary) flex-[3.5] p-[8px_4px] box-border flex flex-col gap-8px">
            <div class="flex gap-4px">
              <div class="bg-var(--hula-brand-primary) size-10px rounded-50%"></div>
              <div class="flex flex-col gap-2px">
                <div class="bg-var(--hula-brand-primary) w-16px h-4px"></div>
          ...
          <div class="bg-var(--hula-brand-primary) flex-[5.5] p-[8px_4px] rounded-[0_6px_6px_0] flex flex-col gap-8px">
            <div class="flex-y-center gap-4px">
              <div class="bg-var(--hula-brand-primary) w-6px h-6px rounded-50%"></div>
              <div class="bg-var(--hula-brand-primary) w-28px h-6px"></div>
            </div>
    ...
    },
    {
      ...
      model: (() => (
        <div class="size-full flex">
          ...
          <div class="bg-var(--hula-brand-primary) flex-1"></div>

          <div class="bg-var(--hula-brand-primary) flex-[4.5] p-[8px_4px] rounded-[0_6px_6px_0] box-border flex flex-col gap-8px">
            <div class="flex gap-4px">
              <div class="bg-var(--hula-brand-primary) size-10px rounded-50%"></div>
              <div class="flex flex-col gap-2px">
                <div class="bg-var(--hula-brand-primary) w-16px h-4px"></div>
...
const versatileModel: JSX.Element = (() => (
  <div class="w-300px h-200px rounded-8px custom-shadow flex border-(1px solid [--line-color])">
    ...
    <div
      ...
      <div class="flex-y-center gap-4px ml-a">
        <div class="bg-[var(--hula-accent,var(--hula-brand-primary))] w-78px h-16px rounded-4px"></div>
        <div class="bg-[--bg-bubble] w-16px h-16px rounded-50%"></div>
      </div>
    </div>
  </div>
