    ...
    <n-flex vertical align="start" :size="20" class="variation-item">
      ...
      <n-flex align="center" :size="20">
        <div
          ...
          class="w-108px h-84px flex-col-center gap-10px cursor-pointer rounded-8px bg-var(--hula-brand-primary)">
          <img class="size-34px" src="../../../assets/img/hula_bg_l.png" alt="简约风格预览" />
