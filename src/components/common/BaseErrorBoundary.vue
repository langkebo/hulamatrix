      ...
      <slot name="fallback" :error="error" :reset="resetError">
        <div class="error-container">
          ...
          <div class="error-actions">
            <button v-if="onRetry" class="error-button error-button-retry" @click="handleRetry" type="button">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M23 4v6h-6" />
            ...
            <button class="error-button error-button-reset" @click="resetError" type="button">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
