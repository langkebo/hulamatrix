...
const { UnifiedMatrixClient } = require('matrix-js-sdk')
 ...
 * 示例 3: 发送图片消息
 */
async function exampleSendImageMessage() {
  console.log('\n=== 示例 3: 发送图片消息 ===\n')
 ...
 * 示例 4: 发送文件消息
 */
async function exampleSendFileMessage() {
  console.log('\n=== 示例 4: 发送文件消息 ===\n')
 ...
 * 示例 6: 获取会话列表
 */
async function exampleGetSessions() {
  console.log('\n=== 示例 6: 获取会话列表 ===\n')
 ...
 * 示例 7: 获取未读消息数
 */
async function exampleGetUnreadCount() {
  console.log('\n=== 示例 7: 获取未读消息数 ===\n')
 ...
 * 示例 9: 搜索私聊消息
 */
async function exampleSearchMessages() {
  console.log('\n=== 示例 9: 搜索私聊消息 ===\n')
 ...
 * 示例 11: 创建阅后即焚会话
 */
async function exampleBurnAfterReading() {
  console.log('\n=== 示例 11: 创建阅后即焚会话 ===\n')
